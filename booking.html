...
<body>
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            <a class="navbar-brand" href="#"><img style="width: 100%;height:120px;object-fit:contain;"
                    src="./asset/images/weblogo.jpg" alt=""></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <button onclick="book()" class="btn custom-btn" type="submit" id="nav-button">Booking
                            Now</button>
                    </li>
                </ul>
            </div>
    ...
    <!-- banner -->
    <section class="banner-8 d-flex justify-content-center align-items-center">
        <h1 class="display-4 heading fw-bold text-white">Book Your FLight Now</h1>
    </section>
    <!-- banner -->
<section class="booking">
    <div class="container rounded shadow-sm">
        <form action="">
            ...
            <div class="row">
                <div class="col-md-6 col-12 mb-4">
                    <div class="form-control d-flex flex-column">
                        <p class="h-blue">FLYING FROM</p> <input class="inputbox" placeholder="City or Airport"
                            type="text">
                    </div>
                </div>
                <div class="col-md-6 col-12 mb-4">
            ...
            <div class="btn btn-primary form-control text-center">Book</div>
        </form>
    </div>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                                ...
                                <img style="width: 100px;height:100px; border-radius: 50%;"
                                    src="./asset/images/weblogo.jpg" alt="">
                                <p>
